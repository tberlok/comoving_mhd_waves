...
if __name__ == '__main__':
    ii = test_isothermal_compressible_wave_standing(show=True)
    ii = test_gamma_four_thirds_compressible_wave_standing(show=True, ii=ii)
    ii = test_gamma_five_thirds_compressible_wave_standing(show=True, ii=ii)
    test_gamma_nonstandard_compressible_wave_standing(show=True, ii=ii)
